      ...
      _push(ssrRenderComponent(unref(Form), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="text-center w-full mb-4"${_scopeId}><p class="text-lg font-medium"${_scopeId}> Đã có tài khoản? `);
            ...
            _push2(`</p></div><div class="w-full flex justify-center items-center"${_scopeId}><button class="bgMainColor text-center px-12 py-3 rounded-full text-white ease-in duration-300 hover:opacity-80 w-full"${_scopeId}> Đăng ký </button></div></div></div>`);
            ...
            return [
              ...
              createVNode("div", { class: "mt-24 w-full h-screen flex justify-center items-center bg-white" }, [
                createVNode("div", { class: "desktop:w-[50%] laptop:w-[80%] tablet:w-[90%] mobile:w-[95%] p-4 loginShadow rounded-2xl bg-[#E2FFEB]" }, [
                  createVNode("h1", { class: "uppercase desktop:text-[36px] laptop:text-[36px] tablet:text-[36px] mobile:text-[30px] font-semibold leading-[1em] fontSpaceGrotesk mb-5 text-[#0a3b50] pt-4 text-center" }, " Đăng ký học viên "),
                  createVNode("p", { class: "text-base text-[#009030] font-semibold pb-2" }, [
                    createTextVNode("Họ và tên "),
                  ...
                  createVNode("div", { class: "text-center w-full mb-4" }, [
                    createVNode("p", { class: "text-lg font-medium" }, [
                      createTextVNode(" Đã có tài khoản? "),
                  ...
                  createVNode("div", { class: "w-full flex justify-center items-center" }, [
                    createVNode("button", { class: "bgMainColor text-center px-12 py-3 rounded-full text-white ease-in duration-300 hover:opacity-80 w-full" }, " Đăng ký ")
                  ])
                ])
              ]),
...
//# sourceMappingURL=signUp-5f825e68.js.map

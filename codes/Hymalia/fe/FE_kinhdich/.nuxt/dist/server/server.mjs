import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, nextTick, shallowRef, shallowReactive, isReadonly, effectScope, ref, markRaw, toRaw, watch, unref, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, version, watchEffect, isShallow, h, defineComponent, Suspense, mergeProps, Transition, provide, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-350a928c.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-3dfbdcf4.js").then((m) => m.default || m)
  },
  {
    name: "signUp",
    path: "/signUp",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/signUp-5f825e68.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-6cf02c05.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-aecfa982.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-f4d56669.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

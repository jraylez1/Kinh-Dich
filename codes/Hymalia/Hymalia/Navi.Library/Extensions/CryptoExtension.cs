...
public static class CryptoExtension
{
    ...
    public static string JwtEncode(this string str, string hashKey = null, JwsAlgorithm alg = JwsAlgorithm.HS256)
    {
        return string.IsNullOrEmpty(str) ? string.Empty : JWT.Encode(str, Encoding.UTF8.GetBytes(hashKey ?? Constants.HashKey), alg);
    }

    public static string JwtDecode(this string str, string hashKey = null, JwsAlgorithm alg = JwsAlgorithm.HS256)
    {
        return string.IsNullOrEmpty(str) ? string.Empty : JWT.Decode(str, Encoding.UTF8.GetBytes(hashKey ?? Constants.HashKey), alg);
    }
}